(() => {
  ...
  function printTestPdf(){
    ...
    const css='*{box-sizing:border-box}body{margin:0;color:#203040;font-family:-apple-system,BlinkMacSystemFont,"Noto Sans JP","Yu Gothic",sans-serif;line-height:1.7}.sheet{width:257mm;min-height:364mm;margin:0 auto;padding:17mm 19mm;page-break-after:always}header{display:flex;justify-content:space-between;border-bottom:4px solid #8ed0c1;padding-bottom:10px}.logo{font-weight:800;color:#18324b;font-size:19px}.meta{text-align:right;font-size:15px;font-weight:700;color:#18324b}.meta span{font-size:12px;color:#6b7b8d;font-weight:400}.title{display:flex;align-items:center;gap:10px;margin:20px 0 4px}.title span{font-size:30px}.title h1{margin:0;font-size:30px;color:#18324b}.title small{background:#eaf3ff;color:#2d6cdf;border-radius:20px;padding:3px 11px;font-size:12px}.hint{background:#fff5e8;border-radius:10px;padding:9px 13px;margin:10px 0 16px;color:#805523;font-size:14px}.q,.a{border:2px solid #dbe4ed;border-radius:14px;padding:13px 18px;margin:11px 0;background:#fbfdff}.q:nth-of-type(odd),.a:nth-of-type(odd){border-color:#bfe5dc;background:#f5fffc}.qtop{display:flex;align-items:center;gap:8px}.num{display:grid;place-items:center;background:#18324b;color:#fff;border-radius:50%;width:30px;height:30px;font-weight:800}.tag{font-size:12px;background:#eaf3ff;color:#2d6cdf;border-radius:15px;padding:2px 10px;font-weight:700}.q h2,.a h2{font-size:18px;margin:7px 0;color:#203040}.choices{display:grid;grid-template-columns:1fr 1fr;gap:8px;margin:9px 0}.choices span{border:1px solid #dbe4ed;border-radius:8px;padding:6px 10px;background:#fff}.answer-line{height:32px;border-bottom:1px dashed #aebdca;margin-top:8px}.a p{font-size:15px;margin:7px 0}.correct{background:#e8f7f1;border-radius:8px;padding:7px 10px;color:#146c4b}.a b{color:#18324b}footer{text-align:center;margin-top:18px;color:#6b7b8d;font-size:13px}@page{size:B4 portrait;margin:0}@media print{.sheet{margin:0}}';
